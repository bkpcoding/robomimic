...
class BaseConfig(Config):
    ...
    def experiment_config(self):
        ...
        self.experiment.save.every_n_epochs = 250                    # save model every n epochs (set to None to disable)
        ...
        self.experiment.rollout.n = 10                              # number of rollouts per evaluation
        self.experiment.rollout.horizon = 400                       # maximum number of env steps per rollout
        self.experiment.rollout.rate = 250                           # do rollouts every @rate epochs
